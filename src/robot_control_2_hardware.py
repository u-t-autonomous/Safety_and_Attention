...
if __name__ == '__main__':
    ...
    robot_name='tb3_2'
    vel_controller_2 = controller('/tb3_2/odom', '/tb3_2/cmd_vel') # Using Odom
    # vel_controller_2 = controller('/tb3_2/odom', '/tb3_2/cmd_vel',vicon_track,robot_name) # Using Vicon
    rospy.sleep(1.0)
