...
class RobotSaAEnvironment:
    ...
    def __init__(self, target_state, target_tolerance, gauss_lev_param, planning_horizon,
        ...
        self.all_dv_lower_bounds_nl,self.all_dv_upper_bounds_nl,self.constraints_dyn_lower_bounds_nl,\
        self.constraints_dyn_upper_bounds_nl,self.all_constraints_lower_bounds_nl,self.all_constraints_upper_bounds_nl,\
        self.all_constraints_lower_bounds_proj_nl,self.all_constraints_upper_bounds_proj_nl,self.safely_mpc_init_guess_solver,\
        self.safely_solver_ipopt,self.safely_mpc_projection_solver=self.construct_mpc_solvers_and_get_bounds()
