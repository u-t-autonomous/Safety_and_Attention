...
if __name__ == '__main__':
    ...
    rospy.init_node("robot_control_0_node")
    wait_for_time()
    ready_wait_sub = rospy.Subscriber(quad_ros_namespace + '/trajComplete', Bool, queue_size=10)
    ...
    vel_controller_0.go_to_point(init_point)
