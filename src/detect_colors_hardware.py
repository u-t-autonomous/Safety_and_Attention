...
class object_map(object):
    ...
    def image_CB(self, data):
        ...
        # hsv bounds
        # pink =   ([167, 40, 220],  [171, 180, 255]    , 'pink')
        # green = ([45, 153, 140]   ,[49, 182, 200], 'green')
        # yellow =  ([27, 213, 200]    ,[29, 255, 240], 'yellow')
        pink =   ([150, 130, 200]   ,[190, 160, 240]  , 'pink')
        green = ([40, 130, 100]   ,[80, 200, 125], 'green')
        yellow =  ([10, 155, 180]    ,[70, 220, 240], 'yellow')
        ...
        for color in colors:
            ...
            for pic, contour in enumerate(contours):
                ...
                if(area > 50):
                    if color[2] not in self.object_ID:
