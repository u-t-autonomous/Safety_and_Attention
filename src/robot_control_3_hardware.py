...
if __name__ == '__main__':
    ...
    robot_name='tb3_3'
    vel_controller_3 = controller('/tb3_3/odom', '/tb3_3/cmd_vel') # Using Odom
    # vel_controller_3 = controller('/tb3_3/odom', '/tb3_3/cmd_vel',vicon_track,robot_name) # Using Vicon
    rospy.sleep(1.0)
